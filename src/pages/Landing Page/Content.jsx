                ...
                <div ref={scrollRef}
                    ...
                    <section className="relative w-full min-h-[80vh] flex items-center justify-center bg-black overflow-hidden">
                        ...
                        <div className="relative z-20 max-w-7xl h-full px-6 md:px-12 text-center space-y-10">
                            ...
                            >
                                Get to know me
                                <span className="text-[#9D9D9D] text-xs md:text-sm font-gr block mt-2">Resumé</span>
                            </h3>
                            ...
                            <h2
                                ...
                                style={{ filter: "blur(16px)" }}
                            >
                                Transforming ideas into <span className='text-[#2FA4FF] font-gb tracking-wide italic'>intelligent interfaces</span><br className="hidden sm:block" />
                                through code, creativity, and consistency.
                                <br />
                                Every interaction is crafted to be sleek,<br className="hidden md:block" />
                                <span className='text-[#2FA4FF] font-gb italic'>functional</span>, and user-focused.
                            </h2>
